...
ElementElement.prototype.description = function(definitions) {
    ...
    // Nasty hack to get our search service working.  Looks to be a problem related to nested 
    // xml structures (both area and keywords are nested) causing and infinte loop
    if (this.$type && this.$type != "tns:Area" && this.$type != "tns:ArrayOfKeyword") {
